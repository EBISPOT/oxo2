                ...
                <div className="lg:col-span-3">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                        <InfoCard
                            ...
                            externalLinks={[
                                { href: process.env.REACT_APP_SSSOM_HOME, text: "Simple Standard for Sharing Ontological Mappings (SSSOM)" },
                                { href: process.env.REACT_APP_EBI_HOME, text: "EMBL-EBI" }
                            ]}
                        />
                        <InfoCard
                            icon={<WrenchIcon className={iconClass}/>}
                            title="Related Tools"
                            link={process.env.REACT_APP_SPOT_ONTOTOOLS}
                            ...
                            externalLinks={[
                                { href: process.env.REACT_APP_SPOT_OLS, text: "OLS" },
                                { href: process.env.REACT_APP_SPOT_ZOOMA, text: "ZOOMA" }
                            ]}
                        />
                        <InfoCard
                            icon={<ExclamationTriangleIcon className={iconClass}/>}
                            title="Report an Issue"
                            link={`${process.env.REACT_APP_SPOT_OXO2_REPO}/issues`}
                            ...
                            externalLinks={[
                                { href: `${process.env.REACT_APP_SPOT_OXO2_REPO}/issues`, text: "GitHub issue tracker" },
                                { href: process.env.REACT_APP_SPOT_OLS_ANNOUNCE, text: "OLS announce mailing list" }
                            ]}
                        />
                    </div>
                </div>
