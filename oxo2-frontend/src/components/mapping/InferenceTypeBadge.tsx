...
/**
 * Inference-type badge (ADR-0011): Asserted / SSSOM inference. Replaces the old 2-way
 * asserted/inferred span used across the result tables and the mapping-set selector.
 */
